...
public class TelaExtrato extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        logo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/SistemaBancarioFrontEnd/logo menor.png"))); // NOI18N
        ...
        jButton5.setFont(new java.awt.Font("Segoe UI Symbol", 1, 10)); // NOI18N
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {"Jõao Paulo", "07/04/2026", "+ R$ 7.646.69"},
                {"Michelle Silva", "23/05/2026", "- R$ 580,00"},
                {"Lucas Freitas", "04/05/2026", "- R$ 4.500,00"},
                {"Luci Silva", "13/05/2026", "+ R$ 2.300.00"}
            },
            new String [] {
        ...
        jLabel4.setText("Últimas movimentações");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        this,
                "Você já está na tela de Início!");
    }//GEN-LAST:event_jButton2ActionPerformed

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        JOptionPane.showMessageDialog(
        this,
                "Esta área está em produção e será disponibilizada em breve..");
